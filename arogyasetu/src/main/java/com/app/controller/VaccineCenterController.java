...
public class VaccineCenterController {
    ...
    @PutMapping("/vaccine-center/{centerId}")
    public ResponseEntity<VaccineCenter> updateVaccineCenter(@PathVariable Integer centerId,@RequestBody VaccineCenter center) {
    ...
    @DeleteMapping("/vaccine-center/{centerId}")
    ...
    @GetMapping("/vaccine-center/{centerId}")
